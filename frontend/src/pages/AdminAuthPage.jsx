...
const AdminAuthPage = () => {
  ...
  const responseGoogle = async (authresult) => {
    try {
      ...
      const res = await axios.post(`${API_URL}/admin/google-oauth`, {
      ...
      <div className="bg-violet-900/80 border border-violet-700 rounded-2xl shadow-xl p-8 w-full max-w-md flex flex-col items-center relative z-10">
        ...
        <form className="w-full flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="rounded-lg bg-violet-600 hover:bg-violet-500 text-white font-semibold py-2 transition-colors duration-200 disabled:opacity-50"
          >
          ...
          >
            ...
            >
              <g clipPath="url(#clip0_17_40)">
                <path
                  d="M47.5 24.5C47.5 23.1 47.4 21.7 47.2 20.4H24V28.1H37.2C36.7 30.7 35.1 32.9 32.7 34.4V39.1H40.2C44.1 35.5 47.5 30.5 47.5 24.5Z"
                  fill="#4285F4"
                />
                <path
                  d="M24 48C30.5 48 35.9 45.9 40.2 39.1L32.7 34.4C30.7 35.7 28.3 36.6 24 36.6C18.7 36.6 14.2 32.9 12.7 28.1H5V33C9.3 41.2 16.2 48 24 48Z"
                  fill="#34A853"
                />
                <path
                  d="M12.7 28.1C12.3 26.8 12.1 25.4 12.1 24C12.1 22.6 12.3 21.2 12.7 19.9V15H5C3.2 18.4 2 21.9 2 24C2 26.1 3.2 29.6 5 33L12.7 28.1Z"
                  fill="#FBBC05"
                />
                <path
                  d="M24 11.4C27.1 11.4 29.5 12.5 31.2 13.9L39.4 6.2C35.9 2.9 30.5 0 24 0C16.2 0 9.3 6.8 5 15L12.7 19.9C14.2 15.1 18.7 11.4 24 11.4Z"
                  fill="#EA4335"
                />
              </g>
              <defs>
